"""Everything drawn on screen, plus the mouse handling that drives ROI drawing.

This is the visual layer: the overlay with the status bars, the barcode
entry popup, and the big pass/fail flash. None of it does any inspection
work, it just renders whatever state the main loop hands it.
"""
...
from Settings import (
    WINDOW_NAME, THUMB_W, THUMB_H,
    GREEN, RED, WHITE, YELLOW, GRAY, SLOT_COLORS,
)
