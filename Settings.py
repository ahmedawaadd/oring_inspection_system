"""All the tunable values for the O-ring inspection tool live here.

Pulling these out into one place means I can tweak resolutions, thresholds,
colours and file paths without digging through the rest of the code.
"""
...
DEFAULT_DIFF_THRESHOLD  = 50   # stored x10, divide by 10 for the actual value (0 to 50.0)
